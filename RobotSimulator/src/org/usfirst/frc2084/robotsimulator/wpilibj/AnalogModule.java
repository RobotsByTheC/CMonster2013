...
import org.usfirst.frc2084.robotsimulator.wpilibj.communication.AICalibration;
...
public class AnalogModule extends Module {
     ...
     */
    public static final double kDefaultSampleRate = 50000D;
...
//        m_module.writeConfig_ConvertRate(ticksPerConversion);
     ...
     *
     * Currently unimplemented (and probably unnecessary) in the simulator
     *
...
//        }
    ...
    public long getLSBWeight(final int channel) {
       ...
       return AICalibration.getLSBWeight(getSystemModuleIndex(), channel - 1);
    }
    ...
    public int getOffset(final int channel) {
        ...
        return AICalibration.getOffset(getSystemModuleIndex(), channel - 1);
    }

    public int getSystemModuleIndex() {
        if (m_moduleNumber == 1) {
            return 0;
        } else if (m_moduleNumber == 2) {
            return 3;
        }
