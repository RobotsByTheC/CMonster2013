...
import org.usfirst.frc2084.robotsimulator.wpilibj.networktables2.util.CharacterArrayMap;
		...
		synchronized(this){
			...
			if(tableEntry==null){
				...
				if(tableEntry.getType().id != type.id)
                                    throw new org.usfirst.frc2084.robotsimulator.wpilibj.networktables2.TableKeyExistsWithDifferentTypeException(name, tableEntry.getType());
