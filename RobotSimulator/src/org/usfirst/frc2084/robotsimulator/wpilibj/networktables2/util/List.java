package org.usfirst.frc2084.robotsimulator.wpilibj.networktables2.util;
...
public class List extends ResizeableArrayObject {
    ...
    /**
     * remove the first element in the list where {@link Object#equals(Object)}
     * is true
     *
     * @param object
    ...
    /**
     * @param object
     * @return true if the list contains the given element (where
     * {@link Object#equals(Object)} is true)
     */
