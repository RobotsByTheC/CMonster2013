...
import org.usfirst.frc2084.robotsimulator.driverstation.Joysticks;
import org.usfirst.frc2084.robotsimulator.wpilibj.communication.FRCCommonControlData;
import org.usfirst.frc2084.robotsimulator.wpilibj.communication.FRCControl;
...
//        FRCControl.getCommonControlData(m_controlData, -1/*Semaphore.WAIT_FOREVER*/);
        m_controlData.read();
...
//        }
    ...
    public double getBatteryVoltage() {
        ...
        // Vbatt *--/\/\/\--* Vsample *--/\/\/\--* Gnd
        //         680 Ohms            1000 Ohms
        return 12.0;//m_batteryChannel.getAverageVoltage() * (1680.0 / 1000.0);
    }
