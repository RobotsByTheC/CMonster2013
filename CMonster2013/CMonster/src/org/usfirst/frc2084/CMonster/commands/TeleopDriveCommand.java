...
public class TeleopDriveCommand extends Command {
    ...
    protected void execute() {
        RobotMap.driveBaseSubsystemRobotDrive.arcadeDrive(Robot.oi.getLeftJoystick());
        SmartDashboard.putNumber("Ultrasonic", Robot.driveBaseSubsystem.getUltrasonicDistance());
    }
