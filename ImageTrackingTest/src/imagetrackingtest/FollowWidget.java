 ...
 * @author jrussell
 */
public class FollowWidget extends WPICameraExtension {

    public static final String NAME = "Robots by the C Target Tracker";
...
//                Robot.getTable().putBoolean("found", false);
    ...
    public static void main(String[] args) {
        ...
        // Create the widget
        FollowWidget widget = new FollowWidget(true);
